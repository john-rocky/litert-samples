...
import com.google.ai.edge.examples.rf_detr.view.ApplicationTheme
import com.google.ai.edge.examples.rf_detr.view.DetectionScreen

/**
 * D-FINE-S object detection demo. Both transformer graphs run on the LiteRT CompiledModel GPU; only
 * top-k selection, the per-token tail, decode and NMS run on the CPU (see [RfDetr]). The UI is a thin
