...
package com.google.ai.edge.examples.text_to_image.view
...
import com.google.ai.edge.examples.text_to_image.R
import com.google.ai.edge.examples.text_to_image.UiState
import com.google.ai.edge.examples.text_to_image.ZImageGenerator

/** Text-to-image screen: the prompt, a Generate button, the generation status, and the image. */
@Composable
fun ZImageScreen(uiState: UiState, onGenerate: () -> Unit, modifier: Modifier = Modifier) {
  Scaffold(
    ...
    Column(modifier = Modifier.fillMaxSize().padding(padding).padding(16.dp)) {
      Text(
        text = "${stringResource(R.string.prompt_hint)}: ${ZImageGenerator.PROMPT}",
        fontSize = 14.sp,
      )
